...
| `TYPESAFE_API_KEY` | No                              | —                                                                         | TypeSafe API key for Jev. In Docker Swarm, mount the key as a secret at `/run/secrets/typesafe_api_key` instead of setting it in the environment.         |
